                            ...
                            <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        />
                                        {
                                            errors.price && (
                                                <p
                                                    className='text-red-500 text-sm'
                                                >El precio debe ser mayor a cero</p>
                                            )
                                        }
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        />
                                        {
                                            errors.stock && (
                                                <p
                                                    className='text-red-500 text-sm'
                                                >El stock debe ser mayor a cero</p>
                                            )
                                        }
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        {...register('slug', {
                                            required: true,
                                            validate: (value: string) => !/\s/.test(value) || 'El slug no puede contener espacios en blanco'
                                        })}
                                        className={cn('w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200', {
                                    ...
                                    />
                                    {
                                        errors.slug && (
                                            <p
                                                className='text-red-500 text-sm'
                                            >{errors.slug?.message || 'El slug es requerido'}</p>
                                        )
                                    }
                                </div>
